import type { AttrapeOiseauResolution } from "../../../../lib/rule-runner/rules/level-1/attrape-oiseau-rule.ts";
import type { SiropResolutionPayload } from "../../../../lib/rule-runner/rules/level-1/sirotage-rule.ts";
